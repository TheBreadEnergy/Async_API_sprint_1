...
class MoviesApi(viewsets.GenericViewSet, mixins.ListModelMixin, mixins.RetrieveModelMixin):
    queryset = (
            ...
            .annotate(genres=ArrayAgg("genres__name", distinct=True),
                ...
                writers = ArrayAgg(
                    "persons__full_name",
                    filter=Q(personfilmwork__role=PersonFilmwork.PersonRoleChoice.SCREENWRITER)
                )
                      )
    )
